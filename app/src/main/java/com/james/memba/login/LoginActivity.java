...
import com.james.memba.home.HomeActivity;
...
public class LoginActivity extends AppCompatActivity implements
    ...
    private void handleSignInResult(GoogleSignInResult result) {
        ...
        if (result.isSuccess()) {
            ...
            intent.putExtra("SIGNIN_ACCOUNTID", account.getId());
            intent.putExtra("SIGNIN_IDTOKEN", account.getIdToken());
